...
export default function Navbar() {
  ...
  const marketplaceItems = [
    { label: "Agency Marketplace", href: "/", icon: <path d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m-1 4h1m5-12h1m-1 4h1m-1 4h1m5-12h1m-1 4h1m-1 4h1m5-12h1m-1 4h1m-1 4h1"/> },
