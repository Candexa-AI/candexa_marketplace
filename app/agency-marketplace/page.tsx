...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* HERO */}
      <section className="bg-slate-50 pt-20 px-4 md:px-10 pb-12 md:pb-16 text-center relative overflow-hidden">
        <div className="hidden sm:block absolute opacity-18 pointer-events-none top-5 left-[60px] text-[48px]">📋</div>
        <div className="hidden sm:block absolute opacity-18 pointer-events-none top-[18px] right-[80px] text-[32px]">🌐</div>
        
        <h1 className="font-serif text-[clamp(28px,5vw,54px)] font-normal text-slate-900 leading-[1.15] max-w-[720px] mx-auto mb-[18px] animate-fade-up px-2">
          Search Trusted Recruitment & HR Agencies Worldwide
        </h1>
        <p className="text-[15px] md:text-[17px] text-slate-600 max-w-[520px] mx-auto leading-[1.6] animate-fade-up px-4" style={{ animationDelay: '0.15s' }}>
          Find the right hiring, staffing, and HR partners — faster, smarter, and globally.
        </p>
      </section>

      {/* SEARCH & FILTER */}
      <section className="px-4 md:px-10 max-w-[1220px] mx-auto -mt-6 md:-mt-8 relative z-20">
        <div className="bg-white border border-slate-200 rounded-2xl p-6 md:p-[28px_32px] shadow-sm animate-fade-up" style={{ animationDelay: '0.2s' }}>
